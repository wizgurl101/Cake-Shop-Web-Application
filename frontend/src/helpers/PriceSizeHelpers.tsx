import { SIZE_LARGE_ABBREVIATION, SIZE_LARGE_PRICE, SIZE_MEDIUM_ABBREVIATION, SIZE_MEDIUM_PRICE, SIZE_SMALL_ABBREVIATION, SIZE_SMALL_PRICE } from '../constants/priceConstants';
