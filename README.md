...
## About the project
This project was based the one shown in Brad Traversy's MERN sCommerce Udemy course that I took.  This is meant for me to apply and practice what I learnt to make a full-stack web application using the following technologies:
- Node.js
- Express
- React + Redux
- MongoDB
