...
## About the project
This project was based on the one I made following Brad Traversy's MERN sCommerce Udemy course.  This is meant for me to apply and practice what I learnt to make a full-stack web application using the following technologies:
- Node.js
- Express
- React + Redux
- MongoDB
